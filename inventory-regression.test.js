...
assert.match(source, /#nic-body\{[^}]*overflow-y:auto;overflow-x:hidden;scrollbar-width:none;-ms-overflow-style:none/);
assert.match(source, /\.nic-category-table\{[^}]*overflow-y:auto[^}]*scrollbar-width:none;-ms-overflow-style:none/);
